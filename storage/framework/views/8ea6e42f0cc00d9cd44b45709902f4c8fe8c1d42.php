    ...
    <div class="tab-pane fade active in" id="APPETIZER" >
      ...
      <div class="col-sm-3">
        <div class="product-image-wrapper">
          <div class="single-products">
            <div class="productinfo text-center">
              <img src="<?php echo e(URL::to($product->product_image)); ?>" alt="" />
            ...
            <div class="product-overlay">
              <div class="overlay-content">
                <h2>$ <?php echo e($product->product_price); ?></h2>
                <p><?php echo e($product->product_name); ?></p>
                <a href="<?php echo e(URL::to('/view_product/'.$product->product_id)); ?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
              </div>
            </div>
          </div>
        </div>
