...
<html lang="en">
  ...
  <body>
          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="logo pull-left">
                <a href="<?php echo e(URL::to('/')); ?>"><!-- <img src="<?php echo e(URL::to('frontend/images/home/logo.png')); ?>" alt="The Yummy Pizza" /> --><h3>The Yummy Pizza</h3></a>
              </div>
              ...
              <div class="shop-menu pull-right">
                <ul class="nav navbar-nav">
                  ...
                  if($customer_id ==NULL && $shipping_id==NULL) {
                    ?>
                  <li><a href="<?php echo e(URL::to('/login-check')); ?>"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                    <?php
                  }
                  ...
                  if($customer_id !=NULL && $shipping_id!=NULL) {
                    ?>
                  <li><a href="<?php echo e(URL::to('/payment')); ?>">Checkout</a></li>
                    <?php
                  }
                  ?>
                  ...
                  <li><a href="<?php echo e(URL::to('/customer_logout')); ?>"><i class="fa fa-lock"></i> Logout</a></li>
                    ...
                    ?>
                  <li><a href="<?php echo e(URL::to('/login-check')); ?>"><i class="fa fa-lock"></i> Login</a></li>
                    <?php
                  }
                  ?>           
                </ul>
                ...
                <ul class="nav navbar-nav collapse navbar-collapse">
                  ...
                  <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                    <ul role="menu" class="sub-menu">
                      ...
                      <li><a href="<?php echo e(URL::to('/checkout')); ?>"> Checkout</a></li>
                      <?php  }else{?>
                      <li><a href="<?php echo e(URL::to('/login-check')); ?>"> Checkout</a></li>
                      <?php } ?>
            ...
            <div class="col-sm-7">
                ...
                <div class="video-gallery text-center">
                  <a href="#">
                    <div class="iframe-img">
                      <img src="<?php echo e(URL::to('frontend/images/home/Beef Masala.jpg')); ?>" alt="" />
                    </div>
              ...
              <div class="col-sm-3">
                <div class="video-gallery text-center">
                  <a href="#">
                    <div class="iframe-img">
                      <img src="<?php echo e(URL::to('frontend/images/home/Prawn Masala.jpg')); ?>" alt="" />
                    </div>
              ...
              <div class="col-sm-3">
                <div class="video-gallery text-center">
                  <a href="#">
                    <div class="iframe-img">
                      <img src="<?php echo e(URL::to('frontend/images/home/Beef Chili Onion1.jpg')); ?>" alt="" />
                    </div>
                    <div class="overlay-icon">
                      <i class="fa fa-play-circle-o"></i>
                    </div>
    ...
    <script src="<?php echo e(asset('frontend/js/jquery.prettyPhoto.j')); ?>s"></script>
