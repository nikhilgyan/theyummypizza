...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>The Yummy Pizza :: Pizza Delivery System</title>
	<meta name="description" content="Pizza Delivery System.">
	<meta name="author" content="Nikhil Gyan">
	<!-- end: Meta -->
	...
	<link href="<?php echo e(asset('backend/css/bootstrap-responsive.min.cs')); ?>s" rel="stylesheet">
...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="dashboard"><span>The Yummy Pizza</span></a>
                ...
                <li>
                  ...
                  <a class="dropdown-menu-sub-footer">View all tasks</a>
						...
						<li class="dropdown hidden-phone">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#"><i class="halflings-icon white envelope"></i></a>
							<ul class="dropdown-menu messages">
								<li class="dropdown-menu-title"><span>You have 9 messages</span><a href="#refresh"><i class="icon-repeat"></i></a></li>	
                <li>
                  <a href="#">
										<span class="avatar"><img src="<?php echo e(URL::to('backend/img/avatar.jpg')); ?>" alt="Avatar"></span>
										<span class="header">
											<span class="from">Nikhil Gyan</span>
                ...
                <li>
                  <a href="#">
										<span class="avatar"><img src="<?php echo e(URL::to('backend/img/avatar2.jpg')); ?>" alt="Avatar"></span>
										<span class="header">
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<?php echo e(URL::to('/all-category')); ?>"><i class="icon-envelope"></i><span class="hidden-tablet"> All Category</span></a></li>
						<li><a href="<?php echo e(URL::to('/add-category')); ?>"><i class="icon-tasks"></i><span class="hidden-tablet"> Add category</span></a></li>

						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Products</span></a>
							<ul>
								<li><a class="submenu" href="<?php echo e(URL::to('/add-product')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Product</span></a></li>
								<li><a class="submenu" href="<?php echo e(URL::to('/all-product')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Products</span></a></li>
							</ul>	
						</li>
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Slider</span></a>
							<ul>
								<li><a class="submenu" href="<?php echo e(URL::to('/add-slider')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Slider</span></a></li>
								<li><a class="submenu" href="<?php echo e(URL::to('/all-slider')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Slider</span></a></li>
							</ul>	
						</li>
						<li><a href="<?php echo e(URL::to('/manage-order')); ?>"><i class="icon-list-alt"></i><span class="hidden-tablet"> Manage Order</span></a></li>
						<li><a href="<?php echo e(URL::to('/all-message')); ?>"><i class="icon-envelope"></i><span class="hidden-tablet">Message</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; <?= date("Y") ?> <a href="//bootstrapmaster.com/" alt="Bootstrap Themes">creativeLabs</a></span>
			<span class="hidden-phone" style="text-align:right;float:right">Powered by: <a href="//admintemplates.co/" alt="Bootstrap Admin Templates">Metro</a></span>
		</p>
  ...
  <script src="<?php echo e(asset('backend/js/jquery-1.9.1.min.js')); ?>"></script>
	...
	<!-- end: JavaScript-->
	<script type="text/javascript" src="<?php echo e(asset('//cdnjs.cloudflare.com/ajax/libs/bootbox.js/4.4.0/bootbox.min.js')); ?>"></script>
	<script>    
